...
class StackOverlay extends StatefulWidget {
  ...
  StackOverlay({@required this.foreground, @required this.background, this.showForeground = false});
...
class _StackOverlayState extends State<StackOverlay> with TickerProviderStateMixin {
